        ...
        for (File sourceFile : sourceDirectory.listFiles())
        {
            ...
            writeFile(file, Jsoup.parse(template.replace("$name", name).replace("$title",
                ...
                .replace("$value", value).replaceAll(
                    ...
                    "conf-macro output-block\" data-hasbody=\"true\" data-macro-name=\"note\"><span " +
                    "class=\"aui-icon aui-icon-small aui-iconfont-warning confluence-information-macro-icon\"> " +
                    "</span><div class=\"confluence-information-macro-body\"><p>This page / section has been " +
                    "automatically generated by Cargo's build. Do not edit it directly as it'll be overwritten " +
                    "next time it's generated again.</p></div></div>", "").replace(
                    "<div class=\"confluence-information-macro confluence-information-macro-note " +
                    "conf-macro output-block\" data-hasbody=\"true\" data-macro-name=\"note\"><span " +
                    "class=\"aui-icon aui-icon-small aui-iconfont-warning confluence-information-macro-icon\"> " +
                    "</span><div class=\"confluence-information-macro-body\"><p>This page has been " +
                    "automatically generated by Cargo's build. Do not edit it directly as it'll be overwritten " +
                    "next time it's generated again.</p></div></div>", "")).html());
            System.out.println("  - Wrote file " + file.getAbsolutePath());
        }
